    ...
    <div class="mx-auto px-8" style="max-width:1280px;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="relative bg-[#1a1a1a] bg-opacity-30 rounded-xl p-5 border border-white/5 text-center opacity-60">
                ...
                <p class="text-gray-400 font-bold text-2xl mb-1 line-through">₱2,500</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-[#111111] border border-white/10 rounded-2xl p-6">
                ...
                <ul class="space-y-2 mb-6">
                    @foreach (['Trail running shoes', 'Hydration pack (water bottle)', 'Whistle', 'Mobile phone (fully charged)', 'Race bib (provided)', 'Extra cash', 'Ziploc bag for your trash'] as $item)
