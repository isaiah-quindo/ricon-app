    ...
    <div class="mx-auto px-8" style="max-width:1280px;">
        <div class="grid grid-cols-2 md:grid-cols-6 md:divide-x divide-white/20">
            ...
            <div class="py-8 px-6">
                ...
                <p class="text-white font-black text-2xl">4,200 M+</p>
            </div>
            ...
            <div class="py-8 pr-6 pl-0 md:pl-6">
                ...
                <p class="text-white font-black text-2xl">200</p>
            </div>
            <div class="py-8 px-6">
                <p class="text-white text-xs uppercase tracking-wider mb-1">Price</p>
                <p class="text-white font-black text-2xl">₱4,490</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="mx-auto px-8" style="max-width:1280px;">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <a href="#" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-layer-line text-muted-foreground-1 hover:border-red-500 hover:text-red-500 focus:outline-hidden focus:border-red-500 focus:text-red-500  disabled:opacity-50 disabled:pointer-events-none">
                    View all inclusions
                </a>
            </div>
...
<section class="bg-[#3D1C1C] py-24">
    <div class="mx-auto px-8" style="max-width:1280px;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="bg-[#1a1a1a] bg-opacity-50 rounded-xl p-5 border-red-500 border text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="bg-[#1a1a1a] bg-opacity-50 rounded-xl p-5 border border-white/5 text-center">
                ...
                <p class="text-white font-bold text-2xl mb-1">₱5,500</p>
    ...
    <div class="mx-auto px-8" style="max-width:1280px;">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">The TGC 60 KM Challenge</h2>
                <p class="text-gray-400 leading-relaxed mb-4">The TGC 60KM pushes runners through demanding mountain terrain across Benguet, offering a true taste of the Cordillera without the full 100-kilometer commitment.</p>
                <p class="text-gray-400 leading-relaxed mb-4">Traversing steep trails and dense pine forests, you'll face significant elevation gain and technical footing that will challenge even seasoned trail runners.</p>
                <p class="text-gray-400 leading-relaxed">With 4,200 meters of positive elevation gain and a 24-hour cutoff, the TGC 60KM is no shortcut — it's a race in its own right.</p>
            </div>
...
<section class="bg-[#0d0d0d] py-24">
    <div class="mx-auto px-8 text-center" style="max-width:1280px;">
        <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Ready to conquer 60?</h2>
