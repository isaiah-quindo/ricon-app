...
<head>
    ...
    <title>TGC 60 KM — The Great Cordillera 100</title>
...
<body class="bg-[#0a0a0a] text-white font-sans antialiased">
    ...
    <section class="relative min-h-[70vh] flex items-end overflow-hidden pt-16">
        ...
        <div class="relative z-10 w-full mx-auto px-8 pb-16" style="max-width:1280px;">
            <p class="text-red-400 text-sm font-semibold uppercase tracking-wider mb-2">The Great Cordillera 100</p>
            <h1 class="text-5xl md:text-7xl font-black text-white leading-tight mb-3">
                TGC <span class="text-red-400">60 KM</span>
            </h1>
        ...
        <div class="mx-auto px-8" style="max-width:1280px;">
            <div class="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
                ...
                <div class="py-8 px-6">
                    ...
                    <p class="text-white font-black text-2xl">24 hrs</p>
                </div>
                <div class="py-8 px-6">
    ...
    <section class="bg-[#0d0d0d] py-24">
        <div class="mx-auto px-8" style="max-width:1280px;">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div>
                    <p class="text-red-400 text-sm font-semibold uppercase tracking-wider mb-3">About the Race</p>
                    <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">The Heart of the Cordillera</h2>
                    <p class="text-gray-400 leading-relaxed mb-4">
                        The TGC 60KM offers runners a formidable challenge through the heart of the Cordillera mountain range. A true test of endurance, this distance balances accessibility with the raw difficulty of high-altitude trail running.
                    </p>
                    <p class="text-gray-400 leading-relaxed mb-4">
                        Runners will traverse steep ridgelines, dense forest trails, and sweeping plateau sections before descending into the finish area.
                    </p>
                    <p class="text-gray-400 leading-relaxed">
                        With 7,290 meters of elevation gain and a 24-hour cutoff, the 60KM is an ideal stepping stone for those building toward the full 100.
                    </p>
                </div>
    ...
    <section class="bg-[#111111] py-24">
        <div class="mx-auto px-8" style="max-width:1280px;">
            <p class="text-red-400 text-sm font-semibold uppercase tracking-wider mb-2">Course Profile</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                @foreach ([['AS1 — Km 15', 'Elevation: 1,600m', '15 KM'], ['AS2 — Km 30', 'Elevation: 2,100m', '30 KM'], ['AS3 — Km 45', 'Elevation: 1,800m', '45 KM'], ['Finish Line', 'Benguet, Philippines', '60 KM']] as [$name, $location, $km])
                <div class="bg-[#1a1a1a] rounded-xl p-5 border border-white/5">
                    <p class="text-red-400 text-xs font-semibold uppercase tracking-wider mb-1">{{ $km }}</p>
    ...
    <section class="bg-[#0d0d0d] py-24">
        <div class="mx-auto px-8" style="max-width:1280px;">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16">
                <div>
                    <p class="text-red-400 text-sm font-semibold uppercase tracking-wider mb-3">Requirements</p>
                ...
                <div>
                    <p class="text-red-400 text-sm font-semibold uppercase tracking-wider mb-3">Qualifications</p>
                    <h2 class="text-3xl font-bold text-white mb-8">Who Can Join</h2>
                    <ul class="space-y-3">
                        @foreach (['Minimum age: 18 years old on race day', 'Completion of at least one 30KM+ trail race', 'Valid government-issued ID', 'Medical clearance required', 'Liability waiver must be signed'] as $item)
                        <li class="flex items-center gap-3 text-gray-400">
                            <span class="w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0"></span>
                            {{ $item }}
                        </li>
    ...
    <section class="bg-[#111111] py-24">
        <div class="mx-auto px-8 text-center" style="max-width:1280px;">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Ready to conquer the 60?</h2>
