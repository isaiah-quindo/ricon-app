...
<section class="min-h-[95px] bg-[#1C3D20]" style="background-image: url('/images/pattern-1.svg'); background-repeat: repeat-x; background-size: auto 100%;">
</section>
...
<section class="min-h-[95px] bg-[#102A14]" style="background-image: url('/images/pattern-2.svg'); background-repeat: repeat-x;">
</section>
