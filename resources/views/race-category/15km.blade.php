...
<section class="relative min-h-[58vh] flex items-end overflow-hidden pt-16">
    <div class="absolute inset-0 bg-gray-800 flex items-center justify-center text-gray-600 text-sm select-none">
        <img src="/images/15km-hero.png" alt="TGC15KM" class="w-full h-full object-cover" />
    </div>
    ...
    <div class="mx-auto px-8" style="max-width:1280px;">
        <div class="grid grid-cols-2 md:grid-cols-6 md:divide-x divide-white/20">
            ...
            <div class="py-8 px-6">
                ...
                <p class="text-white font-black text-2xl">₱1,490</p>
            </div>
        </div>
    </div>
</div>
...
<section class="min-h-[95px] bg-[#1C3540]" style="background-image: url('/images/pattern-1.svg'); background-repeat: repeat-x; background-size: auto 100%;">
</section>
    ...
    <div class="mx-auto px-8" style="max-width:1280px;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="bg-[#1a1a1a] bg-opacity-50 rounded-xl p-5 border-cyan-500 border text-center">
                ...
                <p class="text-white font-bold text-2xl mb-1">₱1,490</p>
...
<section class="min-h-[95px] bg-[#102028]" style="background-image: url('/images/pattern-2.svg'); background-repeat: repeat-x;">
</section>
    ...
    <div class="mx-auto px-8" style="max-width:1280px;">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-[#111111] border border-white/10 rounded-2xl p-6">
                ...
                <ul class="space-y-2 mb-6">
                    @foreach (['Minimum age: 16 years old (with parental consent)', 'Valid government-issued ID', 'Liability waiver must be signed', 'Full payment of registration fee'] as $item)
                    <li class="flex items-center gap-3 text-sm text-gray-400">
                        <span class="w-1.5 h-1.5 rounded-full bg-cyan-400 flex-shrink-0"></span>
                        {{ $item }}
                    </li>
    ...
    <div class="mx-auto px-8" style="max-width:1280px;">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">The TGC 15 KM Fun Run</h2>
                <p class="text-gray-400 leading-relaxed mb-4">The TGC 15KM welcomes runners of all levels to experience the magic of the Cordillera trails. No ultra experience required — just the will to move and explore.</p>
