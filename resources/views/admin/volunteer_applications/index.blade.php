...
<form method="GET" action="{{ route('admin.volunteer-applications.index') }}"
    ...
    <a href="{{ route('admin.volunteer-applications.export', request()->query()) }}"
        ...
        <table class="min-w-full divide-y divide-gray-100">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Preferred Role</th>
                    <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">City / Province</th>
                    <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
            ...
            <tbody class="divide-y divide-gray-100 bg-white">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-5 py-4 text-right">
                        <a href="{{ route('admin.volunteer-applications.show', $application) }}"
                ...
                <tr>
                    <td colspan="5" class="px-5 py-12 text-center">
                        <div class="flex flex-col items-center gap-2 text-gray-400">
                            ...
                            <p class="text-sm">No volunteer applications yet.</p>
                        </div>
                    </td>
                </tr>
                @endforelse
