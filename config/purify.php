    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            // Trix editor output tag set (news post bodies)
            'HTML.Allowed' => 'div,p,br,h1,h2,h3,strong,b,em,i,del,s,a[href|title],ul,ol,li,blockquote,pre,figure[class],figcaption,img[src|alt|width|height]',
